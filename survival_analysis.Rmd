...
We construct separate Kaplan-Meier curves for the effect of baseline household by each of the age strata and use a log-rank test to detect significant differences between the observed survival curves. For all age groups, survival curves significantly differ by race ($p < 0.0001$ for ages 43-46, $p < 0.0001$ for ages 46-49, $p = 0.0002$ for ages 50-53). Among all age groups, these differences appear especially large in the lowest income group which experiences a faster decline in survival probability than other groups. This effect is particularly pronounced in women who entered the study between ages 50 and 53.
...
We construct separate Kaplan-Meier curves for the effect of baseline household by each of the age strata and use a log-rank test to detect significant differences between the observed survival curves. For all age groups, survival curves significantly differ by race ($p < 0.0001$ for ages 43-46, $p < 0.0001$ for ages 46-49, $p < 0.0001$ for ages 50-53). Across all age groups, higher BMI groups appear to experience a faster decline in survival probability.
