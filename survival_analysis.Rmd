...
```{r, echo = FALSE}
ggadjustedcurves(dbts.mod.ins, 
                 variable = c("age_group"), 
                 data = surv.comp,
                 ylim = c(0.75, 1.0))
```
...
ggsurvplot(km50_54, 
           ...
           xlab = "Time (t)", 
           ylab = "Survival Probability", 
           title = "Diabetes Survival versus Time Since Study Entry (Age at t = 0, 50-54)",
           legend = "none",
           ylim = c(0.6, 1.0),
           risk.table = TRUE,
           risk.table.height = .5,
