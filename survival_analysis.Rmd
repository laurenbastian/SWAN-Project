...
ggplot(data = surv.df[surv.df$censored == 0,], aes(x = t2event)) +
  geom_histogram(binwidth = 1, fill = '#00BFC4', color = 'white') +
  theme_bw() +
  labs(title = "Time to Event for Uncensored Women") +
  xlab("Time to Event") +
  ylab("Counts") +
...
- Forward model selection process is not clear for survival models.
